...
EXPECTED_MODEL_ID = "facebook/bart-large-mnli"
...
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/bart_zero_shot_classification_train.csv",
...
CODE_MARKERS = (
    # Stage 4: pinned corpus, balanced split, validation, label set, CSV, refusal probes
    "USE_BYOD = False",
...
MARKDOWN_MARKERS = (
    "**Capability:** zero-shot text classification by NLI entailment",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    239_961: "Banking77 test.csv at PolyAI-LDN/task-specific-datasets 57ec275",
    839_073: "Banking77 train.csv at PolyAI-LDN/task-specific-datasets 57ec275",
    138_590_612: "fine-tuned adapter size, Kaggle adaptation run (run record)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "b06e26ac675513959a63135f11b94ea7786ed02da65db93a5650d8838cbc664b": "Banking77 train.csv at PolyAI-LDN/task-specific-datasets 57ec275",
    "d12d6e3bc4c3103966ae786dc435913c0c563dfa328f5a3646d0e62cfeeb474d": "Banking77 test.csv at PolyAI-LDN/task-specific-datasets 57ec275",
}
